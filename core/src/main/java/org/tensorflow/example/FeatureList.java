...
public final class FeatureList extends
    ...
    public static final class Builder extends
        ...
        private void buildPartialRepeatedFields(org.tensorflow.example.FeatureList result) {
            if (featureBuilder_ == null) {
        ...
        private void buildPartial0(org.tensorflow.example.FeatureList result) {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        case 0:
                            ...
                            break;
                        case 10: {
                            org.tensorflow.example.Feature m =
                                    input.readMessage(
                                            org.tensorflow.example.Feature.parser(),
                                            extensionRegistry);
                            if (featureBuilder_ == null) {
                                ensureFeatureIsMutable();
                                feature_.add(m);
