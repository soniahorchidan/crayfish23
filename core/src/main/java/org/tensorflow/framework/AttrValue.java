...
public final class AttrValue extends
    ...
    public static final class ListValue extends
        ...
        internalGetFieldAccessorTable() {
            return org.tensorflow.framework.AttrValueProtos.internal_static_tensorflow_AttrValue_ListValue_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            org.tensorflow.framework.AttrValue.ListValue.class,
                            org.tensorflow.framework.AttrValue.ListValue.Builder.class);
        }
        ...
        public static final class Builder extends
            ...
            public org.tensorflow.framework.AttrValue.ListValue buildPartial() {
                org.tensorflow.framework.AttrValue.ListValue result = new org.tensorflow.framework.AttrValue.ListValue(
                        this);
            ...
            private void buildPartialRepeatedFields(org.tensorflow.framework.AttrValue.ListValue result) {
            ...
            private void buildPartial0(org.tensorflow.framework.AttrValue.ListValue result) {
                ...
                try {
                    ...
                    while (!done) {
                        ...
                        switch (tag) {
                            ...
                            case 74: {
                                org.tensorflow.framework.NameAttrList m =
                                        input.readMessage(
                                                org.tensorflow.framework.NameAttrList.parser(),
                                                extensionRegistry);
                                if (funcBuilder_ == null) {
                                    ensureFuncIsMutable();
                                    func_.add(m);
    ...
    public org.tensorflow.framework.DataType getType() {
        if (valueCase_ == 6) {
            org.tensorflow.framework.DataType result = org.tensorflow.framework.DataType.forNumber(
    ...
    public static final class Builder extends
        ...
        private void buildPartial0(org.tensorflow.framework.AttrValue result) {
            int from_bitField0_ = bitField0_;
        }

        private void buildPartialOneofs(org.tensorflow.framework.AttrValue result) {
        ...
        public Builder mergeShape(org.tensorflow.framework.TensorShapeProto value) {
            if (shapeBuilder_ == null) {
                if (valueCase_ == 7 &&
                    ...
                    value_ = org.tensorflow.framework.TensorShapeProto
                            .newBuilder((org.tensorflow.framework.TensorShapeProto) value_)
        ...
        public Builder mergeTensor(org.tensorflow.framework.TensorProto value) {
            if (tensorBuilder_ == null) {
                if (valueCase_ == 8 &&
                    ...
                    value_ = org.tensorflow.framework.TensorProto
                            .newBuilder((org.tensorflow.framework.TensorProto) value_)
                            .mergeFrom(value).buildPartial();
                } else {
                    value_ = value;
                }
        ...
        public Builder mergeList(org.tensorflow.framework.AttrValue.ListValue value) {
            if (listBuilder_ == null) {
                if (valueCase_ == 1 &&
                    ...
                    value_ = org.tensorflow.framework.AttrValue.ListValue
                            .newBuilder((org.tensorflow.framework.AttrValue.ListValue) value_)
                            .mergeFrom(value).buildPartial();
                } else {
                    value_ = value;
                }
        ...
        public Builder mergeFunc(org.tensorflow.framework.NameAttrList value) {
            if (funcBuilder_ == null) {
                if (valueCase_ == 10 &&
                    ...
                    value_ = org.tensorflow.framework.NameAttrList
                            .newBuilder((org.tensorflow.framework.NameAttrList) value_)
                            .mergeFrom(value).buildPartial();
                } else {
                    value_ = value;
                }
